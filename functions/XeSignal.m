classdef XeSignal < handle
    ...
    methods
        ...
        function this = XeSignal(file, folder)

            this.rawdata = XeSignalRawData(file);
        ...
        function createPhysicalSystem(this, incidenceEnergy, emissionEnergy, slit, foot)
        ...
        function runFluoFitting(this)
            ...
            signal = this.rawdata.signal;
            signalError = this.rawdata.signalError;
